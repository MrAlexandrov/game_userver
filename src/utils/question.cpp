...
auto GetQuestionFromRequest(const userver::server::http::HttpRequest& request)
    ...
    return Models::Question{
        ...
        .image_url = body["image_url"].As<std::optional<std::string>>().value_or(""),
        .question_type = body["question_type"].As<std::optional<Models::QuestionType>>().value_or(Models::QuestionType::kMultipleChoice),
    };
}
