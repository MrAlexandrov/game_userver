...
auto Storage::CreatePack(const Models::Pack& pack) const
...
auto Storage::CreateQuestion(Models::Question&& question) const
...
auto Storage::CreateVariant(const Models::Variant& variant) const
...
auto Storage::GetAllGameSessions() const -> std::vector<Models::GameSession> {
...
auto Storage::CreateTextAnswer(const Models::TextAnswer& text_answer) const
