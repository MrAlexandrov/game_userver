...
UTEST(UuidFromStringTest, ValidUuidString) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(valid_uuid_str);
...
UTEST(UuidFromStringTest, UppercaseUuidString) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(uppercase_uuid_str);
...
UTEST(UuidFromStringTest, InvalidUuidStringReturnsEmpty) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(invalid_uuid_str);
...
UTEST(UuidFromStringTest, EmptyStringReturnsEmpty) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(empty_str);
...
UTEST(UuidFromStringTest, PartialUuidStringReturnsEmpty) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(partial_uuid_str);
...
UTEST(UuidFromStringTest, RandomStringReturnsEmpty) {
    ...
    boost::uuids::uuid result = NUtils::StringToUuid(random_str);
